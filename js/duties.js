let arrDungeons = [
    ...
    {Name: "The Tam-Tara Deepcroft", Bold: true, Spoilers: true, ID: 669},
    ...
    {Name: "The Stone Vigil", Bold: true, Spoilers: true, ID: 672},
    ...
    {Name: "Copperbell Mines (Hard)", Spoilers: true, SpoilersUntil: 783, ID: 871},
    {Name: "Haukke Manor (Hard)", Spoilers: true, SpoilersUntil: 784, ID: 872},
    {Name: "The Lost City of Amdapor", ID: 897},
    {Name: "Halatali (Hard)", ID: 895},
    {Name: "Brayflox's Longstop (Hard)", Spoilers: true, SpoilersUntil: 785, ID: 896},
    {Name: "Hullbreaker Isle", ID: 993},
    {Name: "The Stone Vigil (Hard)", Spoilers: true, SpoilersUntil: 786, ID: 992},
    {Name: "The Tam-Tara Deepcroft (Hard)", Spoilers: true, SpoilersUntil: 783, ID: 991},
    {Name: "Snowcloak", Bold: true, Spoilers: true, MinID: 1001, MaxID: 1029, ID: 1039},
    {Name: "Sastasha (Hard)", Spoilers: true, SpoilersUntil: 783, ID: 1038},
    {Name: "The Sunken Temple of Qarn (Hard)", MaxAltID: 1037},
    {Name: "The Keeper of the Lake", Bold: true, Spoilers: true, MinID: 1029, ID: 1072},
...
// Render the list of duties and their completion states.
function renderPage() {
